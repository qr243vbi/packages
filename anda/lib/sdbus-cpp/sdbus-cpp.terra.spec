#? https://src.fedoraproject.org/rpms/sdbus-cpp/blob/rawhide/f/sdbus-cpp.spec
...
Provides:		%realname-devel-doc = %evr
Conflicts:		%realname-devel-doc
...
Provides:		%realname-tools = %evr
Conflicts:		%realname-tools
...
%changelog
* Sat Jun 14 2025 madonuko <mado@fyralabs.com> - 2.1.0-3
- Repackaged into Terra
